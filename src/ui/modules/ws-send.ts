...
//
// A tiny module that holds the active WSClient so any UI module (app.ts,
// macro-panel.ts, etc.) can dispatch messages without being passed the
// client through multiple layers. Set once after connect; every caller
